...
function selectionSetupP1 ()
  ...
  RockSelectP1 = display.newImageRect( "images/Rock Display Select.png", 890, 900)
  RockSelectP1.x = display.contentCenterX-1440
  RockSelectP1.y = display.contentCenterY+640
...
function createFlaxP1 ()  
  ...
  flax_P1 = createImage("images/plant1/plant1.png", 400, 400, display.contentCenterX-1460, display.contentCenterY+645)
  ...
  flax_P1_2 = createImage("images/plant1/plant2.png", 400, 400, display.contentCenterX-1460, display.contentCenterY+645)
  ...
  flax_P1_3 = createImage("images/plant1/plant3.png", 400, 400, display.contentCenterX-1460, display.contentCenterY+645)
  ...
  flax_P1_4 = createImage("images/plant1/plant4.png", 400, 400, display.contentCenterX-1460, display.contentCenterY+645)
  ...
  flax_P1_5 = createImage("images/plant1/plant5.png", 400, 400, display.contentCenterX-1460, display.contentCenterY+645)
  ...
  flax_P1_6 = createImage("images/plant1/plant6.png", 400, 400, display.contentCenterX-1460, display.contentCenterY+645)
...
function createPalmP1 ()
  ...
  palm_P1 = createImage("images/plant2/plant3.png", 400, 400, display.contentCenterX-1490, display.contentCenterY+665)
  ...
  palm_P1_2 = createImage("images/plant2/plant2.png", 400, 400, display.contentCenterX-1490, display.contentCenterY+665)
  ...
  palm_P1_3 = createImage("images/plant2/plant1.png", 400, 400, display.contentCenterX-1490, display.contentCenterY+665)
...
function createPineP1 ()
  ...
  pine_P1 = createImage("images/plant4/plant1.png", 600, 1150, display.contentCenterX-1450, display.contentCenterY+595)
  ...
  pine_P1_2 = createImage("images/plant4/plant2.png", 600, 1150, display.contentCenterX-1450, display.contentCenterY+595)
  ...
  pine_P1_3 = createImage("images/plant4/plant3.png", 600, 1150, display.contentCenterX-1450, display.contentCenterY+595)
  ...
  pine_P1_4 = createImage("images/plant4/plant4.png", 600, 1150, display.contentCenterX-1450, display.contentCenterY+595)
  ...
  pine_P1_5 = createImage("images/plant4/plant5.png", 600, 1150, display.contentCenterX-1450, display.contentCenterY+595)
  ...
  pine_P1_6 = createImage("images/plant4/plant6.png", 600, 1150, display.contentCenterX-1450, display.contentCenterY+595)
  ...
  pine_P1_7 = createImage("images/plant4/plant7.png", 600, 1150, display.contentCenterX-1450, display.contentCenterY+595)
...
function createFernP1 ()
  ...
  fern_P1 = createImage("images/plant3/plant1.png", 400, 400, display.contentCenterX-1490, display.contentCenterY+665)
  ...
  fern_P1_2 = createImage("images/plant3/plant2.png", 400, 400, display.contentCenterX-1490, display.contentCenterY+665)
  ...
  fern_P1_3 = createImage("images/plant3/plant3.png", 400, 400, display.contentCenterX-1490, display.contentCenterY+665)
  ...
  fern_P1_4 = createImage("images/plant3/plant4.png", 400, 400, display.contentCenterX-1490, display.contentCenterY+665)
...
function colouringSetupP1()
  ...
  --------------------------------------
  -- creates colour selection buttons.
  --------------------------------------
  local RockColourP1 = display.newImageRect( "images/Rock Display.png", 890, 920)
  ...
  btn_new1.x = display.contentCenterX-1680
  btn_new1.y = display.contentCenterY+1320
  P1Colouring:insert( btn_new1 )

  btn_new2 = display.newImageRect( "images/paintbuttons/paletteButton2.png", 130, 130)
  btn_new2.color = { 0.3, 0.5, 0.1 }
  btn_new2.x = display.contentCenterX-1530
  btn_new2.y = display.contentCenterY+1330
  P1Colouring:insert( btn_new2 )
  ...
  btn_new3.y = display.contentCenterY+1330
  P1Colouring:insert( btn_new3 )
  ...
  btn_new4.y = display.contentCenterY+1320
  P1Colouring:insert( btn_new4 )

  ---------------------------------------------------------------------------------------------
  -- creates done buttons for when you're finished colouring, set to invisible on level start.
  ---------------------------------------------------------------------------------------------
  donebtn_spawnFlaxP1 = display.newImageRect( "images/Done Button Template.png", 350, 150)
  donebtn_spawnFlaxP1.x = display.contentCenterX-1540
  donebtn_spawnFlaxP1.y = display.contentCenterY+1460
  toggleVisibility( donebtn_spawnFlaxP1 )
  P1Colouring:insert( donebtn_spawnFlaxP1 )

  donebtn_spawnPalmP1 = display.newImageRect( "images/Done Button Template.png", 350, 150)
  donebtn_spawnPalmP1.x = display.contentCenterX-1540
  donebtn_spawnPalmP1.y = display.contentCenterY+1460
  toggleVisibility( donebtn_spawnPalmP1 )
  P1Colouring:insert( donebtn_spawnPalmP1 )

  donebtn_spawnPineP1 = display.newImageRect( "images/Done Button Template.png", 350, 150)
  donebtn_spawnPineP1.x = display.contentCenterX-1540
  donebtn_spawnPineP1.y = display.contentCenterY+1460
  toggleVisibility( donebtn_spawnPineP1 )
  P1Colouring:insert( donebtn_spawnPineP1 )

  donebtn_spawnFernP1 = display.newImageRect( "images/Done Button Template.png", 350, 150)
  donebtn_spawnFernP1.x = display.contentCenterX-1540
  donebtn_spawnFernP1.y = display.contentCenterY+1460
  ...
  compostButtonFlaxP1.x = display.contentCenterX-1300
  compostButtonFlaxP1.y = display.contentCenterY+1460
  ...
  compostButtonPalmP1.x = display.contentCenterX-1300
  compostButtonPalmP1.y = display.contentCenterY+1460
  ...
  compostButtonPineP1.x = display.contentCenterX-1300
  compostButtonPineP1.y = display.contentCenterY+1460
  ...
  compostButtonFernP1.x = display.contentCenterX-1300
  compostButtonFernP1.y = display.contentCenterY+1460
