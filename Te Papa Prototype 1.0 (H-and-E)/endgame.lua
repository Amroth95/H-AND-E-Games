...
function scene:create( event )
    ...
    local myText = display.newText( "Game is completed:", 160, 200, native.systemFont, 16 )
    ...
    local myRoundedRect = display.newRoundedRect( 160, 240, 180, 50, 12 )
    ...
    local myButtonText = display.newText( "Return to Splashscreen", 160, 240, native.systemFont, 16 )
